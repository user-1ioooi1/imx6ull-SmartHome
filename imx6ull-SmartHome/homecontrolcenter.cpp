...
#include "ui_homecontrolcenter.h"


HomeControlCenter::HomeControlCenter(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::HomeControlCenter)
{
    ui->setupUi(this);
    ...
    connect(ui->stackedWidget, &QStackedWidget::currentChanged,
            this, &HomeControlCenter::onStackedWidgetChanged);
}

HomeControlCenter::~HomeControlCenter()
{
    delete ui;
}


void HomeControlCenter::on_basicFuncUIBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(BasicFunctionsPg);
}

void HomeControlCenter::on_musicPlayerBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(MusicPlayerPg);
}

void HomeControlCenter::on_videoPlayerBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(VideoPlayerPg);
}

void HomeControlCenter::on_cameraBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(CameraPg);
}

void HomeControlCenter::on_aiAssistantBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(AiAssistantPg);
}

void HomeControlCenter::onStackedWidgetChanged(int index)
{
    prePage = curPage;
